...
namespace Kztek_Data
{
    public class Kztek_Entities : DbContext
    {
        ...
        public DbSet<CPURAM_ServerLog> CPURAM_ServerLogs { get; set; }

        public DbSet<Time_ServerLog> Time_ServerLogs { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CPURAM_ServerLog>(entity =>
            {
                entity.HasKey(e => e.Id);
            });

            modelBuilder.Entity<Time_ServerLog>(entity =>
            {
                entity.HasKey(e => e.Id);
            });
        }
